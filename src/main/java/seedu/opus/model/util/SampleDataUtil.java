...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        ...
        try {
            return new Task[] {
                new Task(new Name("Finalise CS2101 Report"), "1", new Priority("hi"), new Status("incomplete"),
                ...
                new Task(new Name("Buy a new laptop"), "2", new Priority("mid"), new Status("incomplete"),
                ...
                new Task(new Name("Clean the toilet"), "3", new Priority("low"), new Status("incomplete"),
                    new Note("Mom says she can smell it from a mile away."),
                    new DateTime(currentDate.plusDays(2)), new DateTime(currentDate.plusDays(3)),
                    new UniqueTagList("personal")),
                new Task(new Name("Prepare for job interviews"), "4", new Priority("mid"), new Status("incomplete"),
                ...
                new Task(new Name("Do CS2103 Tutorial"), "5", new Priority("low"), new Status("incomplete"),
